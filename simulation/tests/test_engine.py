"""Focused tests for the Python simulation engine foundation."""
...
def test_basic_simulation_runs_and_emits_telemetry() -> None:
    stage = Stage(
        stage_number=0,
        name="Core",
        dry_mass_kg=1200.0,
    ...
    assert result.summary.max_altitude_m > 0.0
